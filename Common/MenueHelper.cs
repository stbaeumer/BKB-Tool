   ...
   return new Menue(
    ...
    [
      ...
      m =>
      {
       ...
       /*m.GetGruppen(
        ...
        [
         ...
         datei => datei.DieseAttributeWerdenBeimVergleichIgnoriert = new string[]{"Page"},
     ...
     new Menüeintrag(
      ...
      klassen,
      [
       $"Die Wiki-Seite/Tabelle [{Global.GetColor(Global.ColorHinweise)}]schulgemeinschaft[/] wird abgeglichen.",
