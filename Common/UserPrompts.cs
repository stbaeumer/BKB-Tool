...
public static class UserPrompts
{
    ...
    private static bool _skipConfirmation = false;

    public static bool SkipConfirmation
    {
        get => _skipConfirmation;
        set => _skipConfirmation = value;
    }
    ...
    /// </summary>
    public static void ConfirmOrThrow(string question)
    {
        if (_skipConfirmation) return;
